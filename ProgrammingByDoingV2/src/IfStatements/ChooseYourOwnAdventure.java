        ...
        if(userChoice1 == 1){
            ...
            if(userChoice1 == 1){
                ...
                if(userChoice1 == 1){
                    ...
                    System.out.println("You make it outside, but she runs you down. You don't make it.");
                }
                ...
                userChoice1 = sc.nextInt();
                if(userChoice1 == 1){
                    System.out.println("Wrong choice, she never rolls first. You don't make it.");
                }else{
            ...
            if(userChoice1 == 1){
                ...
                if(userChoice1 == 1){
                    ...
                    System.out.println("You make it outside, but a woman runs you down. You don't make it.");
                }
                ...
                if(userChoice1 == 1){
                    ...
                    System.out.println("Wrong choice, 25 is far too little. You don't make it.");
