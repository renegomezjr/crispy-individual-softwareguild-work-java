...
public class DoWhileSwimming {
        // 1. 80.5, both swim for the same amount of time
        // 2. Gallant doesn't swim.
        // 3. Gallant checks the temp. first then doesn't swim.
        // 4. Goofus jumps right in.
        // 5. while loop check's condition first. Do-while does at least one interation.
        // 6. pre-test - while loop, post-test - do-while
