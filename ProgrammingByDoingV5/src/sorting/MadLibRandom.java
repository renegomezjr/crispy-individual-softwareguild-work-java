...
public class MadLibRandom {
    ...
    public static void main(String[] args) {
        ...
        int advi1 = 0 + (int) (Math.random() * adverbs.length); //adverb
        ...
        System.out.printf("red, and there were colorful wildflowers all around. %s and %s\n", male, female);
