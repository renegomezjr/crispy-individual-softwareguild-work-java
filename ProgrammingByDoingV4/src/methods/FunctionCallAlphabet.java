...
public class FunctionCallAlphabet {
    ...
    public static void main(String[] args) {
        ...
        String b = b();    // returns the word to be displayed
        ...
        f("Friday");    // displays the word you pass it beginning with "F"
        String g = g();    // returns the word to be displayed
        h(1);    // tell it how many times to display the word (1)
        System.out.println(b);

        i(1);    // pass it any integer and it will display a word beginning with I 
        String j = j(2);    // returns a different word depending on what you pass it (1-3)
        ...
        n("Now");    // displays the word you pass it beginning with "N"
        o();    // displays a word beginning with O and returns a useless value
        String p = p();    // returns the word to be displayed
        q();    // displays the word
        ...
        t("Time");    // displays the word you pass it beginning with "T"
        String u = u();    // returns the word to be displayed
        v(2);    // tell it how many times to display the word (1)
        w(2);    // pass it any integer and it will display a word beginning with W 
        String x = x(2);    // returns a different word depending on what you pass it (1-2)
        y();   // displays a word beginning with Y
        String z = z(false, false);    // returns a different word depending on which two boolean values you pass it
        System.out.println(u + x + z);
    }
